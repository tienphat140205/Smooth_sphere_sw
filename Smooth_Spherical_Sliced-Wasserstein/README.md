...
For a maintained version of the code of optimal transport on the circle and the Spherical Sliced-Wasserstein distance, we refer to the [POT](https://pythonot.github.io/gen_modules/ot.sliced.html) library, see `ot.sliced.sliced_wasserstein_sphere`, `ot.sliced.sliced_wasserstein_sphere_unif`, `ot.lp.wasserstein_circle`.
